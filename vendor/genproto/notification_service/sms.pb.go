...
type SendSmsRespone struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SendSmsRespone) Reset() {
	*x = SendSmsRespone{}
	if protoimpl.UnsafeEnabled {
...
func (x *SendSmsRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendSmsRespone) ProtoMessage() {}

func (x *SendSmsRespone) ProtoReflect() protoreflect.Message {
	mi := &file_sms_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendSmsRespone.ProtoReflect.Descriptor instead.
func (*SendSmsRespone) Descriptor() ([]byte, []int) {
...
var file_sms_proto_rawDesc = []byte{
	0x0a, 0x09, 0x73, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x0e, 0x53,
	...
	0x6e, 0x64, 0x53, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65, 0x32, 0x32, 0x0a, 0x03,
	0x53, 0x4d, 0x53, 0x12, 0x2b, 0x0a, 0x07, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x6d, 0x73, 0x12, 0x0f,
	0x2e, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x0f, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65,
...
var file_sms_proto_goTypes = []interface{}{
	...
	(*SendSmsRespone)(nil), // 1: SendSmsRespone
}
var file_sms_proto_depIdxs = []int32{
	0, // 0: SMS.SendSms:input_type -> SendSmsRequest
	1, // 1: SMS.SendSms:output_type -> SendSmsRespone
